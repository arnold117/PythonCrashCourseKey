class Car():
    """A simple attmpt to represent a car."""


    def __init__(self, manufacturer, model, year):
        """Initialize attributes to descrobe a car."""
...
class Battery():
    ...
    def upgrade_battery(self):
        ...
        if self.battery_size == 60:
            ...
            print("Upgraded the battery tp 85 kWh")
        else:
...
print("Make an electric car, and check it again:")
